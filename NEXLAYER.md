...
**Live:** [https://relaxed-weasel-rss-bridge.cloud.nexlayer.ai](https://relaxed-weasel-rss-bridge.cloud.nexlayer.ai)  
...
**rss-bridge** is deployed on [Nexlayer](https://nexlayer.ai) — a container-native
...
application:
  ...
  pods:
  - name: app
    image: mirror.gcr.io/rssbridge/rss-bridge:latest
    path: /
    servicePorts:
    - 80
```
